...
const schema = new mongoose.Schema({
  ...
  address: { type: String, trim: true }, taxId: { type: String, trim: true }, notes: { type: String, trim: true }, serviceTypes: { type: [{ type: String, enum: ['laser_cut', 'powder_coating', 'purchase_material'] }], default: [] }, status: { type: String, enum: ['active', 'inactive'], default: 'active' },
}, { timestamps: true });
