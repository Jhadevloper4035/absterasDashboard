...
import { authenticate, authorizeAppModule, authorizeHrApprover, authorizeHrModule } from '../auth/middleware/auth.middleware.js';
...
hrRouter.patch('/attendance/:id/correction', authorizeHrApprover, asyncHandler(decideAttendanceCorrection));
...
hrRouter.post('/holidays', authorizeHrApprover, asyncHandler(createHoliday));
hrRouter.patch('/holidays/:id', authorizeHrApprover, asyncHandler(updateHoliday));
hrRouter.delete('/holidays/:id', authorizeHrApprover, asyncHandler(deleteHoliday));
...
hrRouter.patch('/leave/requests/:id', authorizeHrApprover, asyncHandler(decideLeaveRequest));
...
hrRouter.patch('/expenses/:id', authorizeHrApprover, asyncHandler(decideExpenseClaim));
...
hrRouter.get('/payroll/advances', authorizeHrApprover, asyncHandler(listAdvances));
hrRouter.post('/payroll/advances', authorizeHrModule('payroll', 'manage'), asyncHandler(createAdvance));
hrRouter.patch('/payroll/advances/:id', authorizeHrApprover, asyncHandler(decideAdvance));
