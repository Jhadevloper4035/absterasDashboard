...
test('invoice stores the supplied tax-invoice fields and line items', async () => {
  const invoice = new Invoice({ invoiceNumber: '1/2026-27', financialYear: '2026-27', client, invoiceDate: '2026-04-04', poNumber: 'PO-123', poDate: '2026-04-01', grRrNumber: 'GR-1', transport: 'Road', placeOfSupply: 'Uttar Pradesh', placeOfSupplyCode: '09', vehicleNumber: 'hr26ab1234', station: 'Gurugram', dispatchFromAddress: 'Warehouse A', lineItems: [{ description: 'ALUMINIUM SHEET', hsnCode: '7606', quantity: 1, unit: 'NOS', unitPrice: 842347.46, lineAmount: 842347.46 }], taxableAmount: 842347.46, igstAmount: 151622.54, roundOff: -0.0, grandTotal: 993970, status: 'unpaid' });
  ...
  assert.equal(invoice.dispatchFromAddress, 'Warehouse A');
  assert.equal(invoice.poNumber, 'PO-123');
});
